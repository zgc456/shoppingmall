...
public class ShoppingCartServiceImpl implements ShoppingCartService {
    ...
    @Override
    public List<ShoppingCartDTO> queryShoppingCart(Integer userId) {
        List<ShoppingCartDTO> list=new ArrayList<>();
        return Conver_Type.convertToList(list,shoppingCartMapper.queryShoppingCart(userId),"com.zhkj.dto.shoppingcart_dto.ShoppingCartDTO");
    }
